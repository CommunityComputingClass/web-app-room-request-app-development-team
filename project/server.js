...
var info = 'This message was recieved from the server'
...
app.get('/', async (req, res) => {
    try {
        ...
        if (currentBlockIndex !== -1) {
            ...
            // });
            // fs.writeFile('currentBlock.json', JSON.stringify(blockNumber, null, 2), (err) => {
            //     if (err) {
            //         console.error('Error writing to file:', err);
            //         return;
            //     }
            //     console.log('Data has been saved to currentBlock.json');
            // });
            //new
...
function newConnection(socket) {
    ...
    //     //io.sockets.emit('mouse',data); //would send to all including sender
    //     console.log(data);
    // }
}